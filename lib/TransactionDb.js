...
var bitcore = require('capricoincore'),
...
var encodedData = require('soop').load('capricoincore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('capricoincore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('capricoincore/lib/Address', {
