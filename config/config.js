...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.capricoinsight');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\capricoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Capricoin/';
  if (isLinux) dataDir = process.env.HOME + '/.Capricoin/';
}
